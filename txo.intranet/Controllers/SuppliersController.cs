...
namespace txo.intranet.Controllers
{
    ...
    {        
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Address1,Address2,City,State,PostalCode,ContactPhone,TimeZone,Created,Enabled,ContactEmail,ContactName")] Supplier supplier)
        {
            if (ModelState.IsValid)
            {
